...
helm install my-release --version 1.0.4 opendesk-impress/impress
```
...
| frontend.configuration.publicApiOrigin | string | `""` | API origin, defaults to `https://<global.fqdn>` |
| frontend.configuration.publicMediaUrl | string | `""` | media url, defaults to `https://<objectstorehost>` |
| frontend.configuration.publicYProviderUrl | string | `""` | Y Provider websocket URL, defaults to `wss://<global.fqdn>/ws` |
